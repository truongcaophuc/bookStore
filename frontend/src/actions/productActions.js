	...
	(keyword = "", currentPage = 1, price, category, rating = 0) =>
		async (dispatch) => {
			try {
				...
				if (category) {
					link = `https://backend-bookstore-se81.onrender.com/api/v1/products?keyword=${keyword}&page=${currentPage}&price[lte]=${price[1]}&price[gte]=${price[0]}&category=${category}&ratings[gte]=${rating}`;
				}
